...
public class Conta {
    ...
    private Cliente titular;//titular herdado de Cliente
...
//    private int banco;
     ...
     */
    public Conta(double saldoInicial, String num, Cliente tit, Agencia ag) {//alteracao realizada
        saldo = saldoInicial;
        numero = num;
        titular = tit;
        agencia = ag;
//        banco = bc;
     ...
     *            Banco a qual a agencia pertence
     */
    public Conta(String num, Cliente tit, Agencia ag, int bc) {
        this(0, num, tit, ag);
    }
