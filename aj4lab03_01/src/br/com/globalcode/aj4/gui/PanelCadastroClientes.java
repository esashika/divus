...
/**
 * 
 * Esta classe representa um Panel de cadastro de clientes, para ser visualizada
 * deve ser adicionada a um JFrame ou outro container que possa ser visualizado.
 * 
 * @author Globalcode
 * 
 */
public class PanelCadastroClientes extends JPanel {
	...
	/**
	 * Este construtor monta um Panel para inserçao de dados de Cadastro de
	 * Clientes,
	 */
	public PanelCadastroClientes() throws GlobalcodeException {
		...
		/***************************************************************************************************************
		 * Adicao dos paineis pCadastroCliente e pBotoesCadastro no panel
		 * principal
		 **************************************************************************************************************/
	...
	private Cliente loadClienteFromPanel() throws GlobalcodeException {
		System.out
				.println("Carregando o cliente em ediçao para um objeto da classe Cliente");
	...
	class SalvarClienteHandler extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent arg0) {
			...
			try {
				...
				new Thread(new SalvarCliente(cliente)).start();
	...
	class SalvarCliente implements Runnable {
		...
		public void run() {
			try {
				...
				// fim da atualização dos elementos de tela
				...
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						try {
							/*****************************************
							 * Implementar a atualização dos elementos de tela
							 * aqui
							 ****************************************/
						} catch (Exception e) {
							e.printStackTrace();
