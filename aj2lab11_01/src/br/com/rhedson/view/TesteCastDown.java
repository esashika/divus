...
public class TesteCastDown {
	...
	public static void main(String[] args) {
		...
		double saldoInicial = args.length > 0 ? Double.parseDouble(args[0])
				: 0d;
		...
		System.out.println("Foi criada a conta " + conta.getNumero() + " para "
				+ conta.getTitular().getNome() + " com saldo de "
				+ conta.getSaldo());
		...
		if (conta instanceof ContaPoupanca) {
			...
			ContaPoupanca contaPoupanca = (ContaPoupanca) conta; // cast down
																	// para
																	// visualizar
																	// o
																	// aniversario
			System.out.println("Aniversario: "
					+ contaPoupanca.getDataAniversario());

		} else if (conta instanceof ContaEspecial) { // Investigue se a conta
														// aberta é do tipo
														// especial

			// em caso afirmativo imprima uma mensagen de aviso, e o limite
			// estabelecido
			...
			// em caso negativo imprima uma mensagem afirmando que é uma conta
			// simples
