...
class TestaCliente {
    ...
    public static void main(String[] args) {
    	...
    	Cliente variavelCliente = new Cliente();
    	
    	variavelCliente.nome = "GLOBALCODE";
    	variavelCliente.cpf = "123456789";
    	
    	System.out.println(" ---------------- ");
		System.out.println("NOME: "+variavelCliente.nome+" CPF: "+variavelCliente.cpf);
		System.out.println(" ---------------- ");
    }
}
