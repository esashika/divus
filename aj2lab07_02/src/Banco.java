...
//        Agencia a = new Agencia("" + numeroProximaAgencia++, this);
    	...
    	Agencia a = new Agencia(Integer.toString(numeroProximaAgencia), this, 10);//maximo de 10 contas
     ...
     * 
     * @return Retorna um booleano identificando se a agência foi inserida com sucesso
     */
