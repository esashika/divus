...
public class PainelCadastroClientes extends JPanel {
	...
	public PainelCadastroClientes() throws GlobalcodeException {
		...
		// Adicao dos dois painéis no frame principal
	 ...
	 * dos JTextFields. Os dados lidas dos campos de texto são usados para criar
	...
	private Cliente loadClienteFromPanel() throws GlobalcodeException {
		 ...
		 * getText(). Armazene cada dado lido em uma variável para usar
		 * posteriormente.
		 */
		...
		System.out.printf(nome, telefone, cpf);
	 ...
	 * dados do cliente.
	 */
	private void clearClienteFromPanel() {// limpando a tela
		// c) Faca a limpeza dos campos de texto colocando uma String vazia ("")
		// por meio do método setText(String s) do componente JTextField
	...
	private void loadClienteToPanel(Cliente c) {
		if (c != null) {
			 ...
			 * tela (use o método setText do JTextField).
			 */
		}
	}
